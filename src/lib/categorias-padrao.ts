...
export const CATEGORIAS_PADRAO: Omit<Categoria, 'criado_em'>[] = [
  ...
  { id: 'reservas', nome: 'Reservas', icone: '🏦', cor: '#0EA5E9', tipo: 'despesa' },
  { id: 'trabalho_despesa', nome: 'Trabalho', icone: '💼', cor: '#2563EB', tipo: 'despesa' },
  { id: 'impostos_taxas', nome: 'Impostos e taxas', icone: '🧾', cor: '#DC2626', tipo: 'despesa' },
  { id: 'manutencao', nome: 'Manutenção', icone: '🔧', cor: '#F97316', tipo: 'despesa' },
  ...
  { id: 'trabalho_receita', nome: 'Trabalho', icone: '🛠️', cor: '#14B8A6', tipo: 'receita' },
  { id: 'reservas_receita', nome: 'Reservas', icone: '💰', cor: '#06B6D4', tipo: 'receita' },
  { id: 'bonus_comissao', nome: 'Bônus e comissões', icone: '🏆', cor: '#F59E0B', tipo: 'receita' },
...
export const PALAVRAS_CHAVE_CATEGORIAS: Record<string, string> = {
  ...
  // Reservas e trabalho
  reserva: 'reservas',
  'reserva de emergência': 'reservas',
  caixinha: 'reservas',
  aporte: 'reservas',
  trabalho: 'trabalho_despesa',
  escritório: 'trabalho_despesa',
  uniforme: 'trabalho_despesa',
  ferramenta: 'trabalho_despesa',
  equipamento: 'trabalho_despesa',

  // Impostos e manutenção
  taxa: 'impostos_taxas',
  imposto: 'impostos_taxas',
  licenciamento: 'impostos_taxas',
  ipva: 'impostos_taxas',
  ...
  // Receitas
  salário: 'trabalho_receita',
  pagamento: 'trabalho_receita',
  comissão: 'bonus_comissao',
  bônus: 'bonus_comissao',
  resgate: 'reservas_receita',
